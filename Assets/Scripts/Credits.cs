...
public class Credits : MonoBehaviour
{
    ...
    IEnumerator ScrollCredits()
    {
        ...
        +"\nДмитрия Ветохина за прекрасный фотошоп и помощь с сюжетом про Аянами Рей"
        +"\nСпасибо Борису за ночь с Выживало"
        +"\nСпасибо Илье и за продумывание сюжета с Геншином и помощью с модельками"
        +"\nСпасибо Максиму за разработку последнего уровня с музыкалкой и продумывания сюжета с Геншином!"
        +"\nИ главного нашего терпилу - Гранта, озвучить все это было очень тяжело!"
